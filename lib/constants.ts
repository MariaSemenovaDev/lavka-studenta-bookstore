...
export const CATALOG_METADATA = {
  title: "Recommend — Книжная Лавка Студента",
  description:
    "Recommend книжного магазина: учебная книга, методическая литература, наглядные пособия, книги для детей, внеклассное чтение и букинистические издания.",
} as const;
