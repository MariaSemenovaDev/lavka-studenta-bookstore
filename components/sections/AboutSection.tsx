      ...
      <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <Reveal>
          <SectionTitle
            ...
            description="Книжная Лавка Студента — магазин в Новороссийске, где можно подобрать учебники, методическую литературу, книги для детей, внеклассное чтение, букинистические издания и наглядные материалы."
          />
        </Reveal>
