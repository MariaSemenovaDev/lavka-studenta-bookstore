...
const audienceItems = [
  ...
  {
    title: "Для родителей",
    description: "Развивающие игры и материалы для занятий дома без перегруженного выбора.",
    icon: SmilePlus,
  },
  {
    title: "Для педагогов",
  ...
  {
    title: "Для студентов",
    description: "Книги, деловая литература и учебные материалы для учебы и саморазвития.",
